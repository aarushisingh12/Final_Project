...
int writeToSummaryFile(struct customerInfo nextCustomer,int server_name) {//writes to appropriate day's summary file, ticket number will be used to search summary later on {
